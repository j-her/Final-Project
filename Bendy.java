...
/**
 * Write a description of class Bendy here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Bendy extends Creature
{
     public Bendy(World w)
    {
    ...
    /**
     * Act - do whatever the Bendy wants to do. This method is called whenever
    ...
    public void act() 
    {
        ...
        if(getHealthBar().getCurrent()<=0)
         {
           getWorld().showText("Bendy has fainted...",getWorld().getWidth()/2,getWorld().getHeight()/2+26);
           Greenfoot.delay(30);
    ...
    public void switchCreature( int idx )
    {
        ...
        else
        {
            ...
            {
                playerWorld.changePlayerTwo("Freddy");
            }
